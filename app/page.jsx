...
export default function Home() {
  ...
  // }
  return (
    <main className="flex bg-[#101213]">
      <div className="w-48">
        <Drawer />
      </div>
      <article className="w-screen h-screen p-10">
        ...
        <section className="w-full bg-[#1e1f25] mt-10 p-5 rounded-2xl">
          <div className="utility-btn mb-5">
            <div className="flex justify-between">
              <ul className="rounded-full flex justify-between items-center border border-gray-700 text-[.9rem] h-8 px-[0.10rem]">
